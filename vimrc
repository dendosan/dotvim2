...
"Position cursor on the word/variable/function/whatever you want to search across the whole project.
"In command mode, <C-r><C-w> will put the word under the cursor as the text in the command area.
map <Leader><C-f> :Find<space><C-r><C-w><CR>
